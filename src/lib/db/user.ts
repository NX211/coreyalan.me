...
export class UserService {
  static async createUser(invoiceNinjaClient: InvoiceNinjaClient) {
  ...
  static async getUserByInvoiceNinjaId(invoiceNinjaId: string) {
  ...
  static async updateUser(invoiceNinjaId: string, data: Partial<InvoiceNinjaClient>) {
